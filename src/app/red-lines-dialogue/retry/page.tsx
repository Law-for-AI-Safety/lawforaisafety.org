...
export default async function RedLinesRetryPage({
  searchParams,
}: {
  ...
  return (
    <ContentPage gap={6}>
      ...
      <p className="text-lg text-brand-black/80">
        Something went wrong signing you in. Please try again. Your
        application details are saved, so you don&apos;t need to retype
        anything.
      </p>
      ...
      {!token ? (
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <form action="/api/red-lines-dialogue/apply/retry" method="post" className="flex-1">
